...
do
  ...
  then
    ...
    INSERT_GAMEDATA_RESULT=$($PSQL "INSERT INTO games(round,year,winner_goals,opponent_goals,winner_id,opponent_id) VALUES($ROUND,$YEAR,$WINNER_GOALS,$OPPONENT_GOALS,)") 
  fi
done
